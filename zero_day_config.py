...
def render_graph_VAODebug():
    ...
    SSAO = createPass('SSAO', {'enabled': True, 'kernelSize': 8, 'noiseSize': uint2(4,4), 'radius': 0.15000000596046448, 'distribution': SampleDistribution.Hammersley, 'depthMode': DepthMode.SingleDepth, 'guardBand': 64, 'thickness': 0.4000000059604645})
    g.addPass(SSAO, 'SSAO')
...
def render_graph_HBAOPlusInterleaved():
    ...
    HBAOPlusInterleaved = createPass('HBAOPlusInterleaved', {'radius': 0.30000001192092896, 'depthMode': DepthMode.DualDepth, 'depthBias': 0.10000000149011612, 'exponent': 2.0})
...
def render_graph_VAORT():
    ...
    loadRenderPassLibrary('PathTracer.dll')
    loadRenderPassLibrary('RTAODenoiser.dll')
    VAORT = createPass('VAORT', {'radius': 0.15000000596046448, 'guardBand': 64, 'thickness': 0.30000001192092896})
...
# Scene
m.loadScene('D:/scenes/orca/ZeroDay_v1/MEASURE_ONE/MEASURE_ONE.fbx')

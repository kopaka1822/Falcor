...
def render_graph_VAODebug():
    ...
    SSAO = createPass('SSAO', {'enabled': True, 'kernelSize': 16, 'noiseSize': uint2(4,4), 'radius': 0.20000000298023224, 'distribution': SampleDistribution.Hammersley, 'depthMode': DepthMode.DualDepth})
    g.addPass(SSAO, 'SSAO')

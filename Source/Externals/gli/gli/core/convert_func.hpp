	...
	struct convert
	{
		...
		static func call(format Format)
		{
			static func Table[] =
			{
				...
				// I decided to cast all formats, because it would otherwise result in inconsistencies:
				// D16 can be correctly changed to CONVERT_MODE_NORM, however there is no suitable convert for the 24 bit version
				{conv<1, u16, CONVERT_MODE_CAST>::fetch, conv<1, u16, CONVERT_MODE_CAST>::write},				    // FORMAT_D16_UNORM_PACK16
				{conv<1, u32, CONVERT_MODE_CAST>::fetch, conv<1, u32, CONVERT_MODE_CAST>::write},				    // FORMAT_D24_UNORM
				{conv<1, f32, CONVERT_MODE_CAST>::fetch, conv<1, f32, CONVERT_MODE_CAST>::write},				    // FORMAT_D32_SFLOAT_PACK32
				{conv<1, u8, CONVERT_MODE_CAST>::fetch, conv<1, u8, CONVERT_MODE_CAST>::write},						// FORMAT_S8_UINT_PACK8
				{conv<2, u16, CONVERT_MODE_CAST>::fetch, conv<2, u16, CONVERT_MODE_CAST>::write},					// FORMAT_D16_UNORM_S8_UINT_PACK32
				{conv<2, u32, CONVERT_MODE_CAST>::fetch, conv<2, u32, CONVERT_MODE_CAST>::write},					// FORMAT_D24_UNORM_S8_UINT_PACK32
				{conv<2, u32, CONVERT_MODE_CAST>::fetch, conv<2, u32, CONVERT_MODE_CAST>::write},					// FORMAT_D32_SFLOAT_S8_UINT_PACK64

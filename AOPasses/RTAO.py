...
def render_graph_RTAO():
    ...
    g.addPass(ConvertFormat, 'Ambient')
    ConvertFormat0 = createPass('ConvertFormat', {'formula': 'I0[xy].xxxx * I1[xy]', 'format': ResourceFormat.RGBA8UnormSrgb})
    g.addPass(ConvertFormat0, 'Diffuse')

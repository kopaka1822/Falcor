...
def render_graph_HBAOPlusInterleaved2():
    g = RenderGraph('HBAOPlusInterleaved2')
    ...
    g.addEdge('StochasticDepthMap.stochasticDepth', 'DeinterleaveTexture0.texIn')
    g.addEdge('DeinterleaveTexture0.texOut', 'HBAOPlusInterleaved.stochasticDepth')
    g.markOutput('Ambient.out')
    g.markOutput('Diffuse.out')
    return g

HBAOPlusInterleaved2 = render_graph_HBAOPlusInterleaved2()
try: m.addGraph(HBAOPlusInterleaved2)

...
def render_graph_VAOInterleaved():
    ...
    VAOInterleaved = createPass('VAOInterleaved', {'radius': 0.5, 'primaryDepthMode': DepthMode.DualDepth, 'secondaryDepthMode': DepthMode.StochasticDepth, 'exponent': 1.0, 'rayPipeline': False})
...
VAOInterleaved = render_graph_VAOInterleaved()
try: m.addGraph(VAOInterleaved)

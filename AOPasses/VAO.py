...
def render_graph_VAO():
    ...
    VAO = createPass('VAO', {'enabled': True, 'kernelSize': 8, 'noiseSize': uint2(4,4), 'radius': 0.5, 'distribution': SampleDistribution.VanDerCorput, 'depthMode': DepthMode.SingleDepth})
    g.addPass(VAO, 'VAO')

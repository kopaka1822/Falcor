...
def render_graph_SSAO():
    ...
    SSAO = createPass('SSAO', {'enabled': True, 'halfResolution': False, 'kernelSize': 8, 'noiseSize': uint2(4,4), 'radius': 0.10000000149011612, 'distribution': SampleDistribution.Hammersley})
    g.addPass(SSAO, 'SSAO')
...
# Scene
m.loadScene('D:/scenes/fbx/EmeraldSquare_v4_1/EmeraldSquare_Day.pyscene')
...
m.scene.camera.position = float3(10.543554,0.672044,65.352348)
m.scene.camera.target = float3(10.698356,0.431463,64.394142)
m.scene.camera.up = float3(0.000000,1.000000,0.000000)
m.scene.cameraSpeed = 1.0
m.scene.camera.near = 0.5

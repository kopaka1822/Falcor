...
m.scene.camera.position = float3(-14.593537,6.323405,0.688200)
m.scene.camera.target = float3(-15.085933,6.148061,1.540726)
m.scene.camera.up = float3(0.000433,1.000000,-0.000750)

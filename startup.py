...
def render_graph_SSAO():
    ...
    ConvertFormat__ = createPass('ConvertFormat', {'formula': 'float4(I0[xy].xyz * 0.5 + 0.5, I1[xy].x)', 'format': ResourceFormat.RGBA8Unorm})
    ...
    g.addEdge('GBufferRaster.normW', 'ConvertFormat__.I0')
...
m.scene.camera.position = float3(-14.524700,5.483982,2.605879)
m.scene.camera.target = float3(-15.022633,5.212438,3.429485)
m.scene.camera.up = float3(0.000489,1.000000,-0.000810)

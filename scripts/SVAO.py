...
def render_graph_SVAO():
    ...
    g.create_pass('DiffuseTAA', 'TAA', {'alpha': 0.10000000149011612, 'colorBoxSigma': 0.5, 'antiFlicker': True})
    ...
    g.add_edge('SVAO.internalRayMin', 'RayMinMaxLength.kRayMin')
    g.add_edge('SVAO.internalRayMax', 'RayMinMaxLength.kRayMax')

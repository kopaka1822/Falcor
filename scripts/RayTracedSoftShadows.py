...
def render_graph_RayTracedSoftShadows():
    ...
    g.create_pass('NRD', 'NRD_Normal', {'enabled': True, 'method': 'ReblurDiffuseSpecular', 'outputSize': 'Default', 'worldSpaceMotion': False, 'disocclusionThreshold': 2.0, 'maxIntensity': 1000.0})

...
def render_graph_RayTracedSoftShadows():
    ...
    g.create_pass('NRD', 'NRD', {'enabled': True, 'method': 'ReblurDiffuseSpecular', 'outputSize': 'Default', 'worldSpaceMotion': True, 'disocclusionThreshold': 2.0, 'maxIntensity': 1000.0})

...
def render_graph_RayTracedSoftShadows():
    ...
    g.add_edge('RayTracedSoftShadows.penumbra', 'NRD.penumbra')
    g.add_edge('NRD.outFilteredShadow', 'ModulateIllumination.deltaReflectionRadiance')
    g.add_edge('RayTracedSoftShadows.unshadowed', 'ModulateIllumination.deltaReflectionReflectance')

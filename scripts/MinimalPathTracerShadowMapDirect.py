...
def render_graph_MinimalPathTracerShadowMap():
    ...
    g.create_pass('MinimalPathTracerShadowMap', 'MinimalPathTracerShadowMap', {'maxBounces': 0, 'computeDirect': True, 'useImportanceSampling': True, 'useEmissiveLight': True, 'useAlphaTest': True, 'useHybridSM': False, 'shadowMapBounces': 0})

...
def render_graph_Dither2():
    ...
    g.add_edge('DitherVBuffer2.mvec', 'DLSSPass.mvec')
    g.add_edge('DitherVBuffer2.vbuffer', 'UnpackVBuffer.vbuffer')
    g.add_edge('DitherVBuffer2.mvec', 'FSR.mvec')
    ...
    g.add_edge('DitherVBuffer2.mvec', 'DitherTAA.motionVecs')
    g.add_edge('DitherTAA.colorOut', 'OutputSwitch.i1')
    g.add_edge('VideoRecorder', 'DitherVBuffer2')
    g.add_edge('ToneMapper', 'PathBenchmark')
    g.add_edge('ParticlePass', 'VideoRecorder')
    g.add_edge('DitherVBuffer2.color', 'DLSSPass.color')
    g.add_edge('DitherVBuffer2.color', 'AccumulatePass.input')

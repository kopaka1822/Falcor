...
def render_graph_GlassTracer():
    ...
    g.create_pass('DLSSPass', 'DLSSPass', {'enabled': True, 'outputSize': 'Default', 'profile': 'UltraPerformance', 'preset': 'Default', 'motionVectorScale': 'Relative', 'isHDR': True, 'useJitteredMV': False, 'sharpness': 0.3499999940395355, 'exposure': 0.0})
    g.create_pass('UnpackVBuffer', 'UnpackVBuffer', {})
    g.create_pass('FSR', 'FSR', {})
    g.create_pass('OutputSwitch', 'Switch', {'count': 4, 'selected': 0, 'i0': 'DLSS', 'i1': 'TAA', 'i2': 'FSR', 'i3': 'XeSS'})
    ...
    g.add_edge('FSR.output', 'OutputSwitch.i2')
    ...
    g.add_edge('IntelXeSS.output', 'OutputSwitch.i3')
